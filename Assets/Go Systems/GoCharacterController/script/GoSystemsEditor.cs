        ...
        public  class minue : EditorWindow
        {
           ...
           public static GUISkin _mySkin;
            ...
            private void OnGUI()
            {
                ...
                animator = EditorGUILayout.ObjectField("AnimatorController", animator, typeof(Object), true);
                ...
                if (GUILayout.Button("Create", _mySkin.button))
                {
                    ...
                    var aim = animator as RuntimeAnimatorController;
                    if (Controler.GetComponent<Animator>() == null)
                    {
                        ...
                        if (anim.avatar != null)
                        {
                            ...
                            {
                                anim.runtimeAnimatorController = aim;
                        ...
                        {
                            Massage = "Add avatar to your animator to contenue create player";
                        }
                    }
                    else
                    {
                   //  DestroyImmediate(Controler.GetComponent<Animator>());
                        var anim = Controler.GetComponent<Animator>();
                        var aime = animator as RuntimeAnimatorController;
                        anim.runtimeAnimatorController = aime;
                        if (anim.avatar != null)
                        {
                            if (anim.avatar.isHuman == true)
                            {
                                ...
                                var Spicar = anim.GetBoneTransform(HumanBodyBones.Hips).gameObject.AddComponent<AudioSource>();
                                Spicar.playOnAwake = false;
                            }
                        }
                        else
                    ...
                    if (Controler.GetComponent<Animator>() != null)
                    {
                        if (Controler.GetComponent<Animator>().avatar != null)
                        {
                            if (Controler.GetComponent<Animator>().avatar.isHuman == true)
                            {

                                NewCamera.AddComponent<Camera>();
                                var cam = NewCamera.AddComponent<GoCameraSystem>();
                                ...
                                cam.TriggerLayer = CS.cameraLayersTrigger;
                ...
                if (animator == null)
                {
                    ...
                    animator = AssetDatabase.LoadAssetAtPath(path + "animation/Go-systems animator.controller", typeof(Object));
                }
